...
require_once("../../model/Friend.php");
  ...
  try{
    ...
    if (!empty($_POST)) {
      if (empty($_POST["id"])) {
        $friend->create($_POST);
        header("location: /curriculum/Smart_Book_Shelf/views/admin/friends_table.php");
        exit;
      }else{
        $friend->adminEdit($_POST);
        header("location: /curriculum/Smart_Book_Shelf/views/admin/friends_table.php");
        exit;
      }
    }
    ...
    //友だちの情報取得
    if (!empty($_GET["id"])) {
      $result = $friend->adminFindBy($_GET["id"]);
    }
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <p class="index_right"><strong>friend_edit</strong></p>
            <p class="mb20"><a href="friends_table.php">戻る</a></p>
              ...
              <tbody>
                <tr>
                  <form action="" method="post">
                    ...
                    <td><input type="text" name="friends_id" value="<?php if(!empty($result)) echo $result["friends_id"]; ?>"></td>
